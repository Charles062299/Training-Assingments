...
create table 
categories(
category_id varchar2(20) constraint pk_category_id primary key,
...
product_available_qty varchar2(50),
...
customer_id varchar2(20) not null, product_id varchar2(20) not null,
